...
public class Carrinho{
  ...
  private List<livro> itens = new List<livro>();

  public void enviarCarrinho(livro item){
    itens.Add(item);
    this.qnt ++;
  ...
  public void mostrarCarrinho(){
    Console.WriteLine("\nSeu Carrinho:\n");
    Console.WriteLine("\nQuantidade de produtos: " + this.qnt + "\n");
...
class Program{
  ...
  public static void buscarLivro(List<livro> livros, Carrinho c1){
      ...
      foreach (livro item in livros){
        if (item.titulo.Contains(textoBusca) || item.autor.Contains(textoBusca)){
            ...
            encontrou = true;
            Console.WriteLine("\nDeseja enviar para o carrinho?(1-SIM 2-NAO)\n");
            int num = int.Parse(Console.ReadLine());
            
            if(num == 1){

            c1.enviarCarrinho(item);
            Console.WriteLine("Produto armazenado!\n");
            break;
            }
      ...
      switch (escolha){
        ...
        case 2:
          ...
          if (tipoLista == 1){
            ...
            Console.WriteLine("Deseja selecionar um livro específico?\n1 - SIM 2 - NAO");
            num1 = int.Parse(Console.ReadLine());
                if(num1 == 1){
                    buscarLivro(livros, c1);
                }
